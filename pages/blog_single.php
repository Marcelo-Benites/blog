...
<div class="container-erro-login">
	<p><i class="fa fa-times"></i>Você precisa estar conectado para conectar, clique <a href="<?php echo INCLUDE_PATH ?>painel">aqui</a>  para efetuar o login.</p>
</div><!--container-erro-login-->
<?php
}else{?>
	<?php
	   //Inserçao dos comentarios na database
	   if(isset($_POST['postar_comentario'])){
		   ...
		   echo '<script>("Comentário realizado com sucesso")</script>';
	 }
	?>
...
<br  />
<h2 class="postar-comentario">Comentarios existentes<i class="fa fa-comment"></i></h2>
<?php
