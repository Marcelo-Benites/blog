...
<section class="header-noticias">
	<div class="center">	
			...
			<h2>Acompanhe as últimas <b>do Blog</b></h2>
	</div><!--center-->		
</section>
<section class="container-portal" style="max-width: 1400px; background: white;">
	<div class="center">
	<div class="sidebar">
	...
	?>
	   <!--aqui que vou colocar a imagem antes de entrar no conteudo-->
	   <div class="box-single-conteudo">
           <div style="background-image: url('<?php echo INCLUDE_PATH_PAINEL; ?>uploads/<?php echo $value['capa']?>')"class="capa"></div><!--banner-single-->
