...
?>
  ...
  <table>
    ...
    <tr>
      ...
      <td><a actionBtn="delete" class="btn delete1" href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-lista?excluir=<?php echo $value['id']; ?>"><i class="fa fa-times"></i> Excluir</a></td>
    </tr>
