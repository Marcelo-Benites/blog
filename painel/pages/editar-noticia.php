      ...
      if(isset($_POST['acao'])){
        ...
        if($imagem['name'] != ''){
          ...
          if(Painel::imagemValida($imagem)){
            ...
            $arr = ['titulo'=>$nome,'data'=>date('Y-m-d'),'categoria_id'=>$_POST['categoria_id'],'conteudo'=>$conteudo,'slug'=>$slug,'capa'=>$imagem,'id'=>$id,'nome_tabela'=>'tb_site.noticias'];
            Painel::update($arr);
            $slide = Painel::select('tb_site.noticias','id = ?',array($id));
          ...
          $imagem = $imagem_atual;
          $slug = Painel::generateSlug($nome);
          $arr = ['titulo'=>$nome,'categoria_id'=>$_POST['categoria_id'],'conteudo'=>$conteudo,'slug'=>$slug,'capa'=>$imagem,'id'=>$id,'nome_tabela'=>'tb_site.noticias'];
          Painel::update($arr);
          $slide = Painel::select('tb_site.noticias','id = ?',array($id));
