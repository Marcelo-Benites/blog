...
<div class="box-content">
  ...
  <table>
    <tr>
      <td><i class="fa fa-id-card-o"></i> Serviço</td>
      <td>Editar</td>
      <td>Deletar</td>
      <td>#</td>
      <td>#</td>
    ...
    <tr>
      ...
      <td><a actionBtn="delete" class="btn delete1" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-servicos?excluir=<?php echo $value['id']?>"><i class="fa fa-times"></i></a></td>
