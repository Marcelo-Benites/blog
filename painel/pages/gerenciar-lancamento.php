<div class="box-content">
	<h2><i class="fa fa-id-card-o" aria-hidden="true"></i>Lançamentos Cadastrados</h2>
	<div class="busca">
	...
	<?php
		...
		$clientes = MySql::conectar()->prepare("SELECT * FROM `tb_site.lancamento` $query");
		$clientes->execute();
			...
			<div class="box-single">
				...
				<div class="body-box">
					...
					<div class="group-btn">
						...
						<a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-lancamento?id=<?php echo $value['id']; ?>"><i class="fa fa-pencil"></i> Editar</a>
					</div><!--group-btn-->
				</div><!--body-box-->
			</div><!--box-single-->
