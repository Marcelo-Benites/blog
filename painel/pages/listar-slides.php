...
<div class="box-content">
  ...
  <table>
  	...
  	<tr>
  		...
  		<td><a class="btn edit" href="<?php INCLUDE_PATH_PAINEL?>editar-slide?id=<?php echo $value['id']; ?>"><i class="fa fa-pencil"></i></a></td>
  		<td><a actionBtn="delete" class="btn delete1" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-slides?excluir=<?php echo $value['id']?>"><i class="fa fa-times"></i></a></td>
