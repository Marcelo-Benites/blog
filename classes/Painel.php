<?php
  ...
  public static 
    ...
    public static function alert($tipo,$mensagem){
     ...
     public static function imagemValida($imagem){
      if($imagem['type'] == 'image/jpeg' ||
        ...
        $tamanho = intval($imagem['size']/2000);
        if($tamanho < 300)
          return true;
        else
          return false;
    ...
    public static function videoValido($img){
      if($img['type'] == 'video/3ggp' ||
        $img['type'] == 'video/mp4' ||
        $img['type'] == 'video/x-msvideo'||
        $img['type'] == 'video/mpeg' ||
        $img['type'] == 'video/ogg' ||
        $img['type'] == 'video/webm'||
        $img['type'] == 'video/3gpp2'){
         $tamanho = intval($img['size']/209715200);//bytes
           if($tamanho < 200){
             return true;
           }else{
             return false;
  ...
  public static function deleteFile($file){
    ...
    /*
       Método especifico para selecionar apenas 1 registro.
    */
